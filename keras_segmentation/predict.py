...
def predict(model, inp, out_fname=None, checkpoints_path=None):
...
def evaluate( model=None , inp_images=None , annotations=None,inp_images_dir=None ,annotations_dir=None , checkpoints_path=None ):
    ...
    return {"frequency_weighted_IU":frequency_weighted_IU ,"dice-coeeficient":dice_coeff ,"mean_IU":mean_IU , "class_wise_IU":cl_wise_score }
